...
RTL           | [PORT_FROZEN][]         | Done        | Targetting for current top_tetley( Port can be changed later based on top_tetley config)
RTL           | [ARCHITECTURE_FROZEN][] | Done        |
RTL           | [REVIEW_TODO][]         | Done        | PR [#837][] is pending
RTL           | [STYLE_X][]             | Done        |
Code Quality  | [LINT_PASS][]           | Done        |
Code Quality  | [CDC_SETUP][]           | N/A         | top_tetley uses single clock at this moment. (new PR by Tim is pending )
