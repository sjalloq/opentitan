...
module xbar_main (
  ...
  tl_h2d_t tl_sm1_14_us_h2d [3];
  tl_d2h_t tl_sm1_14_us_d2h [3];
  ...
  tl_h2d_t tl_s1n_18_ds_h2d [10];
  tl_d2h_t tl_s1n_18_ds_d2h [10];
  ...
  tl_h2d_t tl_s1n_26_ds_h2d [9];
  tl_d2h_t tl_s1n_26_ds_d2h [9];

  // Create steering signal
  logic [3:0] dev_sel_s1n_26;
  ...
  assign tl_sm1_17_us_h2d[0] = tl_s1n_13_ds_h2d[3];
  assign tl_s1n_13_ds_d2h[3] = tl_sm1_17_us_d2h[0];

  assign tl_sm1_14_us_h2d[1] = tl_s1n_18_ds_h2d[0];
  assign tl_s1n_18_ds_d2h[0] = tl_sm1_14_us_d2h[1];

  assign tl_sm1_15_us_h2d[1] = tl_s1n_18_ds_h2d[1];
  assign tl_s1n_18_ds_d2h[1] = tl_sm1_15_us_d2h[1];

  assign tl_sm1_16_us_h2d[1] = tl_s1n_18_ds_h2d[2];
  assign tl_s1n_18_ds_d2h[2] = tl_sm1_16_us_d2h[1];

  assign tl_sm1_17_us_h2d[1] = tl_s1n_18_ds_h2d[3];
  assign tl_s1n_18_ds_d2h[3] = tl_sm1_17_us_d2h[1];

  assign tl_sm1_20_us_h2d[0] = tl_s1n_18_ds_h2d[4];
  assign tl_s1n_18_ds_d2h[4] = tl_sm1_20_us_d2h[0];

  assign tl_sm1_21_us_h2d[0] = tl_s1n_18_ds_h2d[5];
  assign tl_s1n_18_ds_d2h[5] = tl_sm1_21_us_d2h[0];

  assign tl_sm1_22_us_h2d[0] = tl_s1n_18_ds_h2d[6];
  assign tl_s1n_18_ds_d2h[6] = tl_sm1_22_us_d2h[0];

  assign tl_sm1_23_us_h2d[0] = tl_s1n_18_ds_h2d[7];
  assign tl_s1n_18_ds_d2h[7] = tl_sm1_23_us_d2h[0];

  assign tl_sm1_24_us_h2d[0] = tl_s1n_18_ds_h2d[8];
  assign tl_s1n_18_ds_d2h[8] = tl_sm1_24_us_d2h[0];

  assign tl_sm1_25_us_h2d[0] = tl_s1n_18_ds_h2d[9];
  assign tl_s1n_18_ds_d2h[9] = tl_sm1_25_us_d2h[0];

  assign tl_sm1_14_us_h2d[2] = tl_s1n_26_ds_h2d[0];
  assign tl_s1n_26_ds_d2h[0] = tl_sm1_14_us_d2h[2];

  assign tl_sm1_16_us_h2d[2] = tl_s1n_26_ds_h2d[1];
  assign tl_s1n_26_ds_d2h[1] = tl_sm1_16_us_d2h[2];

  assign tl_sm1_17_us_h2d[2] = tl_s1n_26_ds_h2d[2];
  assign tl_s1n_26_ds_d2h[2] = tl_sm1_17_us_d2h[2];

  assign tl_sm1_20_us_h2d[1] = tl_s1n_26_ds_h2d[3];
  assign tl_s1n_26_ds_d2h[3] = tl_sm1_20_us_d2h[1];

  assign tl_sm1_21_us_h2d[1] = tl_s1n_26_ds_h2d[4];
  assign tl_s1n_26_ds_d2h[4] = tl_sm1_21_us_d2h[1];

  assign tl_sm1_22_us_h2d[1] = tl_s1n_26_ds_h2d[5];
  assign tl_s1n_26_ds_d2h[5] = tl_sm1_22_us_d2h[1];

  assign tl_sm1_23_us_h2d[1] = tl_s1n_26_ds_h2d[6];
  assign tl_s1n_26_ds_d2h[6] = tl_sm1_23_us_d2h[1];

  assign tl_sm1_24_us_h2d[1] = tl_s1n_26_ds_h2d[7];
  assign tl_s1n_26_ds_d2h[7] = tl_sm1_24_us_d2h[1];

  assign tl_sm1_25_us_h2d[1] = tl_s1n_26_ds_h2d[8];
  assign tl_s1n_26_ds_d2h[8] = tl_sm1_25_us_d2h[1];

  assign tl_s1n_13_us_h2d = tl_corei_i;
  assign tl_corei_o = tl_s1n_13_us_d2h;

  assign tl_rom_o = tl_sm1_14_ds_h2d;
  assign tl_sm1_14_ds_d2h = tl_rom_i;

  assign tl_debug_mem_o = tl_sm1_15_ds_h2d;
  assign tl_sm1_15_ds_d2h = tl_debug_mem_i;

  assign tl_ram_main_o = tl_sm1_16_ds_h2d;
  assign tl_sm1_16_ds_d2h = tl_ram_main_i;

  assign tl_eflash_o = tl_sm1_17_ds_h2d;
  assign tl_sm1_17_ds_d2h = tl_eflash_i;

  assign tl_s1n_18_us_h2d = tl_cored_i;
  assign tl_cored_o = tl_s1n_18_us_d2h;
  ...
  assign tl_flash_ctrl_o = tl_sm1_21_ds_h2d;
  assign tl_sm1_21_ds_d2h = tl_flash_ctrl_i;

  assign tl_rv_plic_o = tl_sm1_22_ds_h2d;
  assign tl_sm1_22_ds_d2h = tl_rv_plic_i;

  assign tl_pinmux_o = tl_sm1_23_ds_h2d;
  assign tl_sm1_23_ds_d2h = tl_pinmux_i;

  assign tl_alert_handler_o = tl_sm1_24_ds_h2d;
  assign tl_sm1_24_ds_d2h = tl_alert_handler_i;

  assign tl_nmi_gen_o = tl_sm1_25_ds_h2d;
  assign tl_sm1_25_ds_d2h = tl_nmi_gen_i;

  assign tl_s1n_26_us_h2d = tl_dm_sba_i;
  assign tl_dm_sba_o = tl_s1n_26_us_d2h;

  always_comb begin
    // default steering to generate error response if address is not within the range
    dev_sel_s1n_13 = 3'd4;
    if ((tl_s1n_13_us_h2d.a_address & ~(ADDR_MASK_ROM)) == ADDR_SPACE_ROM) begin
      dev_sel_s1n_13 = 3'd0;
    
    end else if ((tl_s1n_13_us_h2d.a_address & ~(ADDR_MASK_DEBUG_MEM)) == ADDR_SPACE_DEBUG_MEM) begin
      dev_sel_s1n_13 = 3'd1;
    
    end else if ((tl_s1n_13_us_h2d.a_address & ~(ADDR_MASK_RAM_MAIN)) == ADDR_SPACE_RAM_MAIN) begin
      dev_sel_s1n_13 = 3'd2;
    
    end else if ((tl_s1n_13_us_h2d.a_address & ~(ADDR_MASK_EFLASH)) == ADDR_SPACE_EFLASH) begin
      dev_sel_s1n_13 = 3'd3;
    end
  end
  ...
  always_comb begin
    ...
    if ((tl_s1n_18_us_h2d.a_address & ~(ADDR_MASK_ROM)) == ADDR_SPACE_ROM) begin
      ...
      ((tl_s1n_18_us_h2d.a_address <= (ADDR_MASK_PERI[0] + ADDR_SPACE_PERI[0])) &&
       (tl_s1n_18_us_h2d.a_address >= ADDR_SPACE_PERI[0])) ||
      ((tl_s1n_18_us_h2d.a_address <= (ADDR_MASK_PERI[1] + ADDR_SPACE_PERI[1])) &&
       (tl_s1n_18_us_h2d.a_address >= ADDR_SPACE_PERI[1]))
    ) begin
      dev_sel_s1n_18 = 4'd4;
    ...
    end else if ((tl_s1n_18_us_h2d.a_address & ~(ADDR_MASK_RV_PLIC)) == ADDR_SPACE_RV_PLIC) begin
      dev_sel_s1n_18 = 4'd6;
    
    end else if ((tl_s1n_18_us_h2d.a_address & ~(ADDR_MASK_PINMUX)) == ADDR_SPACE_PINMUX) begin
      dev_sel_s1n_18 = 4'd7;
    
    end else if ((tl_s1n_18_us_h2d.a_address & ~(ADDR_MASK_ALERT_HANDLER)) == ADDR_SPACE_ALERT_HANDLER) begin
      dev_sel_s1n_18 = 4'd8;
    
    end else if ((tl_s1n_18_us_h2d.a_address & ~(ADDR_MASK_NMI_GEN)) == ADDR_SPACE_NMI_GEN) begin
      dev_sel_s1n_18 = 4'd9;
    end
  end
