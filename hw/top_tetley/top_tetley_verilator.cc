...
int main(int argc, char **argv) {
  ...
  memutil.RegisterMemoryArea(
      "rom",
      "TOP.top_tetley_verilator.top_tetley.u_rom_rom.gen_mem_generic."
      "u_impl_generic");
  memutil.RegisterMemoryArea(
      "ram",
      "TOP.top_tetley_verilator.top_tetley.u_ram1p_ram_main"
      ".gen_mem_generic.u_impl_generic");
  memutil.RegisterMemoryArea(
      "flash",
      "TOP.top_tetley_verilator.top_tetley.u_flash_eflash."
